...
public class App {
	public static void main(String[] args) {
		...
		GrafoLista<String> grafo = new GrafoLista<String>(true);
		...
		grafo.agregarArista(nodoA, nodoB, 2);
		grafo.agregarArista(nodoA, nodoC, 4);

		grafo.agregarArista(nodoB, nodoC, 3);
		grafo.agregarArista(nodoB, nodoD, 1);
		grafo.agregarArista(nodoB, nodoE, 5);

		grafo.agregarArista(nodoC, nodoD, 2);

		grafo.agregarArista(nodoD, nodoE, 1);
		grafo.agregarArista(nodoD, nodoF, 4);
		...
		System.out.println(grafo.dfs(nodoA));
		 ...
		 * 
		 * grafo.agregarArista(nodoA, nodoB, 1); grafo.agregarArista(nodoA, nodoC, 7);
		 * grafo.agregarArista(nodoA, nodoD, 10); grafo.agregarArista(nodoA, nodoE, 5);
		 * grafo.agregarArista(nodoB, nodoC, 3); grafo.agregarArista(nodoC, nodoD, 4);
		 * grafo.agregarArista(nodoD, nodoE, 2);
		 * 
		 * grafo.dijkstra(nodoA); System.out.println("*Dijkstra:");
		 * grafo.getNodos().forEach((n) ->
		 * System.out.println(n.caminoMasCortoToString())); System.out.println("*BFS:");
		 * System.out.println(grafo.bfs(nodoA)); System.out.println("*DFS:");
		 * System.out.println(grafo.dfsRecursivo(nodoA, new
		 * LinkedHashSet<Nodo<String>>())); System.out.println("*Kruskal:");
		 * grafo.kruskal();
		 */
	}
}
